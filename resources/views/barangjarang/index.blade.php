                                ...
                                <tbody>
                                    ...
                                    @foreach ($barangjarang as $index => $item)
                                        <tr>
                                            ...
                                            <td class="px-6 py-2">
                                                ...
                                                @elseif($item->status == 'Tunggu Verifikasi')
                                                    <span class="p-2 mb-2 bg-warning text-black rounded">Tunggu
                                                        Verifikasi</span> <!-- Yellow for waiting verification -->
                                                @else
                                                    ...
                                                    @endif
                                                    @if (Auth::user()->hakakses('pimpinan'))
                                                        <form action="{{ route('updateStatusAnalisis', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                            ...
                                            @if (Auth::user()->hakakses('petugas') || Auth::user()->hakakses('admin'))
                                                <td class="px-6 py-2">
                                                    <a href="{{ route('barangjarang.edit', $item->id) }}"
                                                        class="btn btn-primary">Edit</a>
                                                    <form action="{{ route('barangjarang.destroy', $item->id) }}"
